...
const Error = () => {
	...
	return (
		<div className='mx-auto mt-4 flex h-fit max-h-[636px] w-full items-center justify-center rounded-lg bg-black bg-opacity-10 p-2.5 lg:w-[1000px]'>
			<div>
				<img src={error} className='mx-auto mt-5 h-40 w-40' />
				...
				<button
					className='mx-auto mb-10 block rounded-md bg-green-600 px-10 py-2 text-xl font-semibold transition duration-200 hover:bg-opacity-90'
					onClick={() => {
						dispatch(fetchRooms())
						dispatch(fetchGame())
					}}
